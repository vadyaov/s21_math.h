...
START_TEST(s21_fmod_test1) {
    ck_assert_double_eq_tol(fmod(12345, 12.234), s21_fmod(12345, 12.234), EPS);
} END_TEST

START_TEST(s21_fmod_test2) {
    ck_assert_double_eq_tol(fmod(0.0, 0.0001), s21_fmod(0.0, 0001), EPS);
} END_TEST
...
START_TEST(s21_fmod_test4) {
    ck_assert_double_eq_tol(fmod(-2834.242, 11.2), s21_fmod(-2834.242, 11.2), EPS);
} END_TEST
...
START_TEST(s21_fmod_test7) {
    ck_assert_double_eq_tol(fmod(2, 1.111), s21_fmod(2, 1.111), EPS);
} END_TEST

START_TEST(s21_fmod_test8) {
    ck_assert_double_eq_tol(fmod(121, 11.0001), s21_fmod(121, 11.0001), EPS);
} END_TEST

START_TEST(s21_fmod_test9) {
    ck_assert_double_eq_tol(fmod(1244.12414, 1244), s21_fmod(1244.12414, 1244), EPS);
} END_TEST

START_TEST(s21_fmod_test10) {
    ck_assert_double_eq_tol(fmod(1.21, -0.99999), s21_fmod(1.21, -0.99999), EPS);
} END_TEST

START_TEST(s21_fmod_test11) {
    ck_assert_double_eq_tol(fmod(1.21, 124214141), s21_fmod(1.21, 124214141), EPS);
} END_TEST
